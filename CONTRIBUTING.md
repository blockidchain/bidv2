Contributing to blockidcoin
============================

The blockidcoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/blockidcoinvps-project/blockidcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the blockidcoin project, and is not to be
confused with overall blockidcoin Network Protocol consensus changes.

Whether a pull request is merged into blockidcoin rests with the project merge
...
The project leader is the release manager for each blockidcoin release.
