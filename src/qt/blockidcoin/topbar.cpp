    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBID}, "amount-small-topbar");
    setCssProperty({ui->labelAmountBID}, "amount-topbar");
    setCssProperty({ui->labelPendingBID, ui->labelImmatureBID}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // BID Total
    QString totalBID = GUIUtil::formatBalance(balance, nDisplayUnit);

    // BID
    // Top
    ui->labelAmountTopBID->setText(totalBID);
    // Expanded
    ui->labelAmountBID->setText(totalBID);
    ui->labelPendingBID->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureBID->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
