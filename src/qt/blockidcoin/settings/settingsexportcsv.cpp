...
#include "qt/blockidcoin/settings/settingsexportcsv.h"
#include "qt/blockidcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(blockidcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("blockidcoin_tx_csv_export(*.csv)") : tr("blockidcoin_addresses_csv_export(*.csv)"),
                                        nullptr);
