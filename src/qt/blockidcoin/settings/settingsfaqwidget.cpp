...
SettingsFaqWidget::SettingsFaqWidget(blockidcoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBID,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBID,
    ...
    connect(ui->pushButton_UnspendableBID, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBID);});
    ...
    if (parent)
        connect(parent, &blockidcoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
