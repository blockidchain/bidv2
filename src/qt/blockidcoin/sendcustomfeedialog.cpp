...
SendCustomFeeDialog::SendCustomFeeDialog(blockidcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &blockidcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
