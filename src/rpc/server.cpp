...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* blockidcoin features */
        {"blockidcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"blockidcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blockidcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"blockidcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"blockidcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"blockidcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blockidcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"blockidcoin", "startmasternode", &startmasternode, true, true, false},
        {"blockidcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blockidcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blockidcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blockidcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blockidcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blockidcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blockidcoin", "preparebudget", &preparebudget, true, true, false},
        {"blockidcoin", "submitbudget", &submitbudget, true, true, false},
        {"blockidcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blockidcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blockidcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blockidcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blockidcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blockidcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blockidcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blockidcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"blockidcoin", "mnsync", &mnsync, true, true, false},
        {"blockidcoin", "spork", &spork, true, true, false},
