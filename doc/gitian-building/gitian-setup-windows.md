...
The build script we'll be using is contained in the blockidcoin github repository ([contrib/gitian-build.py](https://github.com/blockidcoinvps-project/blockidcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the blockidcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/blockidcoinvps-project/blockidcoin/master/contrib/gitian-build.py
