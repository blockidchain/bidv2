...
- [Development guidelines](#development-guidelines)
    - [General blockidcoin](#general-blockidcoin-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
blockidcoin uses [Doxygen](http://www.doxygen.nl/) to generate its official documentation.
...
blockidcoin is a multi-threaded application, and deadlocks or other
...
([`valgrind.supp`](https://github.com/blockidcoinvps-project/blockidcoin/blob/master/contrib/valgrind.supp))
...
However, in open source software such as blockidcoin, where everyone uses
...
pay attention to for reviewers of blockidcoin code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: blockidcoin uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against blockidcoin so that they can be integrated
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:blockidcoinvps-project/blockidcoin.git
