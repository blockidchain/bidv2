...
*Setup instructions for a gitian build of blockidcoin using a VM or physical system.*
...
- [Building blockidcoin](#building-blockidcoin-core)
...
[gitian.sigs](https://github.com/blockidcoinvps-project/gitian.sigs/) repository:
...
You can also mail the files to Fuzzbawls (fuzzbawls@blockidcoin.trade) and he will commit them.
